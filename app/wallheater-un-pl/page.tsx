    ...
    <div className="md:hidden font-sans text-gray-900 overflow-x-hidden">
          ...
          <div className="grid gap-6 items-center">
            ...
            <div className="relative order-1">
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl overflow-hidden shadow-xl relative max-w-xs mx-auto">
                <img src="/images/1.png" alt="Klimatyzator Ścienny Pro 2w1 Bez Jednostki Zewnętrznej" className="w-full h-auto object-contain mix-blend-multiply opacity-90" />
      ...
      <section className="py-8 bg-white border-t border-gray-100">
        <div className="container mx-auto px-3 max-w-5xl">
          <div className="grid gap-6 items-center">
            <div className="order-2">
              <img src="/images/2.png" alt="Zimny dom" className="rounded-xl shadow-lg w-full h-48 object-cover" />
            </div>
      ...
      <section className="py-10 bg-gray-50">
        <div className="container mx-auto px-3">
            ...
            <div className="grid gap-4 max-w-5xl mx-auto">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm">
                    <div className="overflow-hidden rounded-lg mb-3 bg-gray-50">
                        <img src="/images/4.png" alt="Montaż ścienny" className="w-full h-auto object-contain" />
                    </div>
      ...
      <section className="py-10 bg-gray-900 text-white">
        <div className="container mx-auto px-3 max-w-5xl">
            <div className="grid gap-6 items-center">
                ...
                <div>
                    <img src="/images/5.png" alt="Elegancki design" className="rounded-xl shadow-2xl border border-gray-700 w-full" />
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-3 max-w-4xl">
            <div className="grid gap-6 mb-10 items-center">
                 <div className="order-2">
                    <img src="/images/6.png" alt="Widok z boku" className="rounded-lg shadow w-full h-48 object-cover" />
                </div>

...
const App = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      router.push(`/dakujeme?name=${encodeURIComponent(formData.name)}&landing=heater-sk&value=${productPrice}&tid=${transactionId}`);
    }, 1000);
  };
  ...
  return (
    <div className="font-sans text-gray-900 overflow-x-hidden">
      ...
      <img
        src="https://offers.supertrendaffiliateprogram.com/forms/api/ck/?o=529&uid=01980829-601f-7dba-9f7a-150da3869743&lp=529"
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold leading-tight mb-3 sm:mb-4">
                Okamžité teplo tam, kde ho potrebujete – <span className="text-orange-600">bez rizika.</span>
              </h1>
              <p className="text-sm sm:text-lg text-gray-600 mb-4 sm:mb-6">
                Keramický ohrievač PTC 2000W s režimom ECO. Ideálny pre miestnosti <strong>do 50m²</strong>. Objednajte dnes, zaplaťte kuriérovi pri prevzatí.
              </p>

              <ul className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-1 gap-2 sm:gap-3 mb-4 sm:mb-8">
                {[
                  "Platba pri prevzatí",
                  "Bleskové zahrievanie PTC",
                  "Režim ECO - nízke účty",
                  "Pre miestnosti do 50m²",
                  "Tichá prevádzka + Časovač 12h"
                ].map((item, i) => (
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mb-4 sm:mb-6">
                <div className="text-center sm:text-left w-full sm:w-auto">
                  <p className="text-gray-400 text-xs sm:text-sm line-through">Cena: 139,98 €</p>
                ...
                >
                  ...
                  <span className="text-[9px] sm:text-[10px] font-normal opacity-90 mt-1 uppercase tracking-wide">Platíte až kuriérovi</span>
                </button>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-4 text-[10px] sm:text-xs text-gray-500">
                <div className="flex items-center bg-gray-50 px-2 py-1 rounded"><LucideShieldCheck className="w-3 h-3 sm:w-4 sm:h-4 mr-1" /> Záruka 24 mesiacov</div>
                <div className="flex items-center bg-gray-50 px-2 py-1 rounded"><LucideTruck className="w-3 h-3 sm:w-4 sm:h-4 mr-1" /> Expedícia 24h</div>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="bg-gray-100 rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-2xl relative max-w-xs sm:max-w-sm mx-auto lg:max-w-none">
                ...
                <div className="absolute bottom-3 sm:bottom-6 left-3 sm:left-6 right-3 sm:right-6 bg-white/95 backdrop-blur rounded-lg p-3 sm:p-4 shadow-lg border-l-4 border-orange-500">
                  <p className="font-bold text-gray-900 text-xs sm:text-sm">100% Platba pri prevzatí</p>
                  <p className="text-[10px] sm:text-xs text-gray-600">Neriskujete. Platíte až keď uvidíte balík.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-8 text-center">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm sm:text-lg">Ideálny pre miestnosti do 50m²</span>
            </div>
            <div className="hidden sm:block w-px h-6 bg-white/30"></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm opacity-90">
              <span>Obývačka • Spálňa • Kancelária • Kúpeľňa • Garáž</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-10 items-center">
            <div className="order-2 md:order-1">
              <img src="/images/2.png" alt="Chladná obývačka" className="rounded-xl shadow-lg w-full h-48 sm:h-80 object-cover" />
            </div>
            <div className="order-1 md:order-2">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-gray-800">Chladné večery a vysoké účty?</h2>
              <p className="text-sm sm:text-base text-gray-600 mb-4 leading-relaxed">
                Ústredné kúrenie nestačí a vykurovanie celého domu stojí majetok? Nemrznite vo vlastnom kresle.
              </p>
              <div className="bg-orange-50 p-4 sm:p-6 rounded-lg border-l-4 border-orange-500">
                <h3 className="font-bold text-gray-900 text-base sm:text-lg mb-2 flex items-center gap-2">
                  <LucideZap className="text-orange-600 w-5 h-5"/> Riešenie: Teplo za 2 minúty
                </h3>
                <p className="text-xs sm:text-sm text-gray-700">
                  Ceramic Tower Heater Pro 2000 zahreje miestnosť <strong>do 50m²</strong> počas niekoľkých minút. Platíte len za komfort, ktorý potrebujete.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-8 sm:py-12 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 max-w-4xl mx-auto">
                {[
                    { icon: LucideFlame, label: "Keramika PTC", sub: "Rýchle teplo" },
                    { icon: LucideWind, label: "Oscilácia", sub: "Rovnomerný tok" },
                    { icon: LucideThermometer, label: "Termostat", sub: "Stála teplota" },
                    { icon: LucideHome, label: "Do 50m²", sub: "Veľký dosah" }
                ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-10 items-center">
            <div className="order-2 md:order-1">
              <span className="inline-block bg-amber-100 text-amber-800 text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 rounded-full mb-3 uppercase tracking-wide">
                Keramická technológia PTC
              </span>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-gray-900">
                Teplo, ktoré trvá <span className="text-orange-600">aj po vypnutí</span>
              </h2>
              <p className="text-sm sm:text-base text-gray-600 mb-4 leading-relaxed">
                Vďaka keramickému vykurovaciemu telesu PTC ohrievač <strong>akumuluje teplo</strong> a vydáva ho ešte niekoľko minút po vypnutí. To znamená:
              </p>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3 bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm sm:text-base">Nižšie účty za elektrinu</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Keramika vydáva teplo bez spotreby energie - ušetríte až 30% energie</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm sm:text-base">Dlhšie udržanie teploty</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Miestnosť zostáva teplá ešte 15-20 minút po vypnutí ohrievača</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm sm:text-base">Bezpečné pre zdravie</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Keramika PTC nespaľuje kyslík a nevysušuje vzduch v miestnosti</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2">
              <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-xl border border-orange-100">
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <h3 className="font-bold text-lg sm:text-xl text-gray-900">Efekt akumulácie tepla</h3>
                </div>

                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-xs sm:text-sm font-medium text-gray-700">Aktívne vykurovanie</span>
                      <span className="text-xs font-bold text-orange-600">100% výkonu</span>
                    </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-xs sm:text-sm font-medium text-gray-700">5 min po vypnutí</span>
                      <span className="text-xs font-bold text-amber-600">~70% tepla</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-xs sm:text-sm font-medium text-gray-700">15 min po vypnutí</span>
                      <span className="text-xs font-bold text-yellow-600">~40% tepla</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                ...
                <div className="mt-4 sm:mt-6 p-3 bg-green-50 rounded-lg border border-green-200">
                  <p className="text-xs sm:text-sm text-green-800 text-center font-medium">
                    ...
                    Teplo zadarmo po vypnutí = reálne úspory!
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-5xl">
          <div className="bg-slate-900 text-white rounded-xl sm:rounded-2xl p-4 sm:p-8 md:p-12 shadow-2xl relative overflow-hidden">
            <div className="relative z-10 grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
              <div>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">Inteligentný režim ECO</h2>
                <p className="text-blue-100 text-sm sm:text-base mb-4 sm:mb-6">
                  Ohrievač má vstavaný termostat. Nastavíte 22°C a zariadenie automaticky reguluje výkon pre udržanie teploty pri minimálnej spotrebe.
                </p>
                <div className="bg-white/10 p-3 sm:p-4 rounded-lg backdrop-blur-sm border border-white/20">
                    <p className="font-bold text-green-400 mb-1 text-sm sm:text-base">Úspora až 40%</p>
                    <p className="text-xs sm:text-sm">Ohrievač nebeží stále na plný výkon. Po zahriatí miestnosti do 50m² prechádza do udržiavacieho režimu.</p>
                </div>
              </div>
              <div className="flex justify-center">
                 <div className="bg-white text-gray-900 p-4 sm:p-6 rounded-xl shadow-lg w-full max-w-sm">
                    <div className="flex justify-between items-center border-b pb-3 sm:pb-4 mb-3 sm:mb-4">
                        <span className="font-bold text-sm sm:text-lg">Spotreba energie</span>
                        <span className="text-[10px] sm:text-xs bg-green-100 text-green-800 px-2 py-1 rounded">Auto režim</span>
                    </div>
                    <div className="space-y-3 sm:space-y-4">
                        <div>
                            <div className="flex justify-between text-[10px] sm:text-xs mb-1">
                                <span>Štart (studená miestnosť)</span>
      ...
      <section className="py-10 sm:py-16 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4">
            <div className="text-center mb-6 sm:mb-12">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">Komfort používania</h2>
                <div className="flex flex-wrap justify-center gap-1 sm:gap-2">
                    <span className="px-2 sm:px-4 py-1 bg-white border rounded-full text-xs sm:text-sm text-gray-600">Spálňa</span>
                    <span className="px-2 sm:px-4 py-1 bg-white border rounded-full text-xs sm:text-sm text-gray-600">Kancelária</span>
                    <span className="px-2 sm:px-4 py-1 bg-white border rounded-full text-xs sm:text-sm text-gray-600">Obývačka</span>
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-8 max-w-5xl mx-auto">
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
                    <div className="overflow-hidden rounded-lg mb-3 sm:mb-4 bg-gray-50">
                         <img src="/images/3.png" alt="Ovládač" className="w-full h-auto object-contain" />
                    </div>
                    <h3 className="text-base sm:text-xl font-bold mb-2">Plná kontrola z gauča</h3>
                    <p className="text-xs sm:text-base text-gray-600">Ovládačom zmeníte teplotu, zapnete osciláciu alebo nastavíte časovač. Prehľadný LED displej.</p>
                </div>
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
                    <div className="overflow-hidden rounded-lg mb-3 sm:mb-4 bg-gray-50">
                        <img src="/images/4.png" alt="Oscilácia" className="w-full h-auto object-contain" />
                    </div>
                    <h3 className="text-base sm:text-xl font-bold mb-2">Široká oscilácia</h3>
                    <p className="text-xs sm:text-base text-gray-600">Rozvádza teplo rovnomerne po celej miestnosti do 50m², eliminuje studené kúty.</p>
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16 bg-white">
        <div className="container mx-auto px-3 sm:px-4 max-w-4xl text-center">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 sm:mb-8">Bezpečnosť je priorita</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-4 sm:mb-8">
                <div className="p-3 sm:p-4 border border-gray-100 rounded-lg bg-white shadow-sm">
                    ...
                    <h3 className="font-bold mb-1 sm:mb-2 text-sm sm:text-base">Auto-vypínač</h3>
                    <p className="text-xs sm:text-sm text-gray-600">Vypne sa pri prevrátení</p>
                </div>
                <div className="p-3 sm:p-4 border border-gray-100 rounded-lg bg-white shadow-sm">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                        <LucideThermometer className="w-5 h-5 sm:w-6 sm:h-6" />
                    </div>
                    <h3 className="font-bold mb-1 sm:mb-2 text-sm sm:text-base">Ochrana prehriatia</h3>
                    <p className="text-xs sm:text-sm text-gray-600">Čidlo odpojí napájanie</p>
                </div>
                <div className="p-3 sm:p-4 border border-gray-100 rounded-lg bg-white shadow-sm">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">Bezpečný plášť</p>
                </div>
            </div>
            <p className="text-gray-500 italic text-xs sm:text-sm bg-gray-50 inline-block px-3 sm:px-4 py-2 rounded-full">Bezpečné pre deti a domácich miláčikov</p>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 max-w-5xl">
            <div className="grid md:grid-cols-2 gap-6 sm:gap-10 items-center">
                <div>
                    <span className="text-orange-400 font-bold tracking-wider uppercase text-[10px] sm:text-sm mb-2 block">Premium atmosféra</span>
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">Viac než ohrievač. <br />Vytvorte útulnú atmosféru.</h2>
                    <p className="text-gray-300 text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed">
                        Realistický 3D efekt plameňa premení vašu izbu na útulnú oázu.
                    </p>
                    <p className="bg-gray-800 inline-block px-3 sm:px-4 py-2 sm:py-3 rounded text-xs sm:text-sm border-l-2 border-orange-500">
                        <span className="font-bold text-orange-400">Dôležité:</span> Svetelný efekt funguje nezávisle od vykurovania.
                    </p>
                </div>
                <div>
                    <img src="/images/5.png" alt="Efekt krbu" className="rounded-xl shadow-2xl border border-gray-700 w-full" />
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16 bg-white">
        <div className="container mx-auto px-3 sm:px-4 max-w-4xl">
            <div className="grid md:grid-cols-2 gap-6 sm:gap-10 mb-10 sm:mb-20 items-center">
                 <div className="order-2 md:order-1">
                    <img src="/images/6.png" alt="Bočný pohľad" className="rounded-lg shadow w-full h-48 sm:h-80 object-cover" />
                </div>
                <div className="space-y-2 sm:space-y-4 text-xs sm:text-sm order-1 md:order-2">
                    <h3 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-800">Technické parametre</h3>
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-100 pb-2">
                        <span className="text-gray-500">Vykurovacie teleso:</span>
                        <span className="font-semibold text-gray-900">Keramické PTC</span>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-100 pb-2">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-100 pb-2">
                        ...
                        <span className="font-semibold text-gray-900">Diaľkové + Panel</span>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-100 pb-2">
                        <span className="text-gray-500">Spotreba:</span>
                    ...
                    <div className="bg-orange-50 p-3 sm:p-4 rounded mt-4 sm:mt-6 border border-orange-100">
                        <p className="font-bold mb-2 text-orange-900 text-sm">V balení:</p>
                        <ul className="list-disc pl-4 sm:pl-5 text-gray-700 space-y-1 text-xs sm:text-sm">
                            ...
                            <li>Návod na obsluhu SK</li>
                        </ul>
                    </div>
                </div>
            </div>

            <h2 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-8 text-center">Prečo Tower Pro?</h2>
            <div className="overflow-x-auto shadow-lg rounded-lg -mx-3 sm:mx-0">
                <table className="w-full bg-white text-xs sm:text-sm md:text-base min-w-[500px]">
                    <thead className="bg-gray-800 text-white">
                        <tr>
                            <th className="py-3 sm:py-4 px-2 sm:px-4 text-left font-medium">Vlastnosť</th>
                            <th className="py-3 sm:py-4 px-2 sm:px-4 text-center bg-orange-600 font-bold">Tower Pro</th>
                            <th className="py-3 sm:py-4 px-2 sm:px-4 text-center text-gray-400">Teplovzdušný</th>
                            <th className="py-3 sm:py-4 px-2 sm:px-4 text-center text-gray-400">Olejový</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                        <tr>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 font-semibold text-gray-700">Plocha</td>
                        ...
                        <tr>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 font-semibold text-gray-700">Zahrievanie</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center bg-orange-50 font-bold text-orange-700">Okamžité</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center text-gray-600">Rýchle</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center text-gray-500">15-30min</td>
                        </tr>
                        <tr>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 font-semibold text-gray-700">Teplo po vypnutí</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center bg-orange-50 font-bold text-orange-700">15-20 min</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center text-red-500">Žiadne</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center text-gray-600">Dlho</td>
                        </tr>
                        <tr>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 font-semibold text-gray-700">Úspora</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center bg-orange-50 font-bold text-orange-700">Režim ECO</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center text-red-500">Nízka</td>
                            <td className="py-3 sm:py-4 px-2 sm:px-4 text-center text-gray-600">Stredná</td>
                        </tr>
                    </tbody>
                </table>
            </div>
      ...
      <section className="py-10 sm:py-16 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4 max-w-6xl">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 sm:mb-10 text-center">Čo hovoria zákazníci?</h2>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6">
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
                    <div className="text-yellow-400 mb-2 flex text-sm">★★★★★</div>
                    <p className="text-gray-700 mb-3 sm:mb-4 italic text-xs sm:text-base">&quot;Zahreje kúpeľňu 8m² za 3 minúty. Používam aj v obývačke 35m² - zvláda to!&quot;</p>
                    <div className="font-bold text-gray-900 text-sm">– Jana K., Bratislava</div>
                    <span className="text-[10px] sm:text-xs text-green-600 flex items-center mt-1 font-semibold"><LucideCheckCircle className="w-3 h-3 mr-1"/> Overené</span>
                </div>
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
                    <div className="text-yellow-400 mb-2 flex text-sm">★★★★★</div>
                    <p className="text-gray-700 mb-3 sm:mb-4 italic text-xs sm:text-base">&quot;Režim Eco funguje skvelovo. Keramika drží teplo aj po vypnutí!&quot;</p>
                    <div className="font-bold text-gray-900 text-sm">– Martin, Košice</div>
                    <span className="text-[10px] sm:text-xs text-green-600 flex items-center mt-1 font-semibold"><LucideCheckCircle className="w-3 h-3 mr-1"/> Overené</span>
                </div>
                 <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm sm:col-span-2 md:col-span-1">
                    <div className="text-yellow-400 mb-2 flex text-sm">★★★★☆</div>
                    <p className="text-gray-700 mb-3 sm:mb-4 italic text-xs sm:text-base">&quot;Kúrim v garáži 45m². Funguje lepšie, než som čakal.&quot;</p>
                    <div className="font-bold text-gray-900 text-sm">– Tomáš, Žilina</div>
                    <span className="text-[10px] sm:text-xs text-green-600 flex items-center mt-1 font-semibold"><LucideCheckCircle className="w-3 h-3 mr-1"/> Overené</span>
                </div>
            </div>
        </div>
      ...
      {/* CHECKOUT */}
      <section id="objednat" className="py-10 sm:py-16 bg-orange-50/50">
        <div className="container mx-auto px-3 sm:px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="bg-gray-900 text-white p-3 sm:p-4 text-center">
                <h3 className="font-bold text-sm sm:text-lg">VYPLŇTE FORMULÁR PRE OBJEDNANIE</h3>
                <p className="text-[10px] sm:text-xs text-gray-400">Bezpečná platba pri prevzatí balíka</p>
            </div>
            ...
            <div className="grid md:grid-cols-2">
                <div className="p-4 sm:p-6 md:p-8 bg-gray-50 border-b md:border-b-0 md:border-r border-gray-100">
                    <div className="flex gap-3 sm:gap-4 mb-4 sm:mb-6">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-lg p-2 shadow-sm flex-shrink-0">
                            <img src="/images/7.png" alt="Produkt" className="w-full h-full object-contain" />
                        </div>
                        <div>
                    ...
                    <div className="border-t pt-3 sm:pt-4 flex justify-between items-center">
                        <span className="font-bold text-sm sm:text-lg">Celkom:</span>
                    ...
                    <div className="mt-4 sm:mt-6 bg-yellow-50 border border-yellow-100 p-2 sm:p-3 rounded text-[10px] sm:text-xs text-yellow-800 flex gap-2">
                        ...
                        Platíte kuriérovi hotovosťou alebo kartou. Žiadne riziko.
                    </div>
                </div>
                ...
                <div className="p-4 sm:p-6 md:p-8">
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <input type="hidden" name="offer" value="529" />
                        <input type="hidden" name="lp" value="529" />
                        <input type="hidden" name="tmfp" value="" />

                        <div>
                            <label className="text-[10px] sm:text-xs font-bold text-gray-700 uppercase">Meno a priezvisko</label>
                            <input
                              type="text"
                              name="your-name"
                              value={formData.name}
                        ...
                        <div>
                            <label className="text-[10px] sm:text-xs font-bold text-gray-700 uppercase">Telefón (najlepšie mobilný)</label>
                        ...
                        <div>
                            <label className="text-[10px] sm:text-xs font-bold text-gray-700 uppercase">Doručovacia adresa</label>
                            <input
                              type="text"
                              name="street-address"
                        ...
                        <div className="mt-3 sm:mt-4 p-2.5 sm:p-3 bg-green-50 border border-green-200 rounded flex items-center justify-between">
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <span className="font-bold text-xs sm:text-sm text-gray-800">Platba pri prevzatí</span>
                            </div>
                        ...
                        >
                          {isSubmitting ? (
                            ...
                            <>
                              {isFormValid ? 'KÚPIŤ A ZAPLATIŤ PRI PREVZATÍ!' : 'Vyplňte všetky polia správne'}
      ...
      <section className="py-8 sm:py-12 bg-white mb-20 sm:mb-24 md:mb-12">
        <div className="container mx-auto px-3 sm:px-4 max-w-2xl">
          <h2 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-8 text-center">Otázky a odpovede</h2>
          <div className="space-y-2">
            {[
              { q: "Môžem zaplatiť kartou u kuriéra?", a: "Áno, väčšina kuriérov má platobné terminály. Môžete platiť aj hotovosťou." },
              { q: "Koľko stojí doprava?", a: "V aktuálnej akcii je doprava na dobierku úplne zadarmo." },
              { q: "Na akú plochu ohrievač stačí?", a: "Ohrievač je ideálny pre miestnosti do 50m². Vďaka výkonu 2000W ich zahreje veľmi rýchlo." },
              { q: "Drží keramika naozaj teplo?", a: "Áno! Keramické vykurovacie teleso PTC akumuluje teplo a vydáva ho ešte 15-20 minút po vypnutí, čo šetrí energiu." },
              { q: "Kedy dostanem balík?", a: "Objednávky do 14:00 expedujeme ten istý deň. Balík bude u vás do 24-48h." }
            ].map((faq, idx) => (
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-2 sm:p-3 md:hidden z-50 shadow-[0_-5px_15px_rgba(0,0,0,0.1)] safe-area-pb">
        ...
        <div className="flex justify-between items-center gap-2 sm:gap-3">
            ...
            >
                OBJEDNAŤ <LucideTruck className="w-3 h-3 sm:w-4 sm:h-4 ml-1 sm:ml-2" />
            </button>
        </div>
      </div>

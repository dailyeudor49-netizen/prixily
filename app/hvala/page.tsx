...
function ThankYouContent() {
  ...
  const name = searchParams.get('name') || 'Kupac';
  const firstName = name.split(' ')[0];
  const landingSlug = searchParams.get('landing') || 'heater-hr';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8 sm:py-16 px-4">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          <div className="border-b border-gray-100 pb-6 mb-6">
            ...
            <p className="text-gray-600 text-sm">
              Na navedeni broj telefona dobit ćete SMS s potvrdom.
            </p>
          </div>

          {/* What happens next */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900">Što slijedi?</h3>
            ...
            <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">1. Telefonski kontakt</h4>
                <p className="text-sm text-gray-600">
                  Naš savjetnik će vas nazvati unutar 24 sata kako bi potvrdio narudžbu i dogovorio detalje dostave.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-orange-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">2. Slanje u 24-48 sati</h4>
                <p className="text-sm text-gray-600">
                  Nakon potvrde narudžbe, pošiljka će biti poslana kurirskom službom. Dobit ćete broj za praćenje.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">3. Plaćanje pri preuzimanju</h4>
                <p className="text-sm text-gray-600">
                  Platit ćete kuriru gotovinom ili karticom pri preuzimanju paketa. Bez rizika!
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Order Summary */}
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          <h3 className="font-bold text-gray-900 mb-4">Vaša narudžba:</h3>
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">Narudžba potvrđena</p>
            </div>
            <div className="text-right">
              <p className="text-xl font-bold text-orange-600">{conversionValue} {currency}</p>
              <p className="text-xs text-gray-500">+ besplatna dostava</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6 mb-6">
          ...
          <ul className="text-sm text-yellow-800 space-y-1">
            <li>• Primite poziv od našeg savjetnika</li>
            <li>• Provjerite pošiljku prije plaćanja kuriru</li>
            <li>• Sačuvajte račun - to je vaše jamstvo</li>
          </ul>
        </div>

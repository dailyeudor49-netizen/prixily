...
function ThankYouContent() {
  ...
  const landingSlug = searchParams.get('landing') || 'wallheater-it';
  ...
  const conversionValue = customValue ? parseFloat(customValue) : (landingConfig?.defaultValue || 199.99);
  const currency = landingConfig?.currency || 'EUR';
  const productName = landingConfig?.productName || 'Climatizzatore a Parete Pro 2in1';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8 sm:py-16 px-4">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          <div className="border-b border-gray-100 pb-6 mb-6">
            ...
            <p className="text-gray-600 text-sm">
              Riceverai un SMS di conferma al numero di telefono indicato.
            </p>
          </div>

          {/* What happens next */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900">Cosa succede adesso?</h3>
            ...
            <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">1. Contatto telefonico</h4>
                <p className="text-sm text-gray-600">
                  Un nostro consulente ti chiamerà entro 24 ore per confermare l'ordine e concordare i dettagli della consegna.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-orange-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">2. Spedizione in 24-48 ore</h4>
                <p className="text-sm text-gray-600">
                  Dopo la conferma dell'ordine, il pacco verrà spedito tramite corriere. Riceverai il codice di tracciamento.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">3. Pagamento alla consegna</h4>
                <p className="text-sm text-gray-600">
                  Pagherai al corriere in contanti o con carta alla consegna del pacco. Nessun rischio!
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Order Summary */}
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          <h3 className="font-bold text-gray-900 mb-4">Il tuo ordine:</h3>
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
            <div className="w-16 h-16 bg-white rounded-lg p-2 shadow-sm">
              <img src="/images/condizionatore-wall/7.webp" alt={productName} className="w-full h-full object-contain" />
            </div>
            <div className="flex-1">
              <h4 className="font-semibold text-gray-900">{productName}</h4>
              <p className="text-sm text-gray-500">Ordine confermato</p>
            </div>
            <div className="text-right">
              <p className="text-xl font-bold text-blue-600">{conversionValue} {currency}</p>
              <p className="text-xs text-gray-500">+ spedizione gratuita</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6 mb-6">
          ...
          <ul className="text-sm text-yellow-800 space-y-1">
            <li>• Rispondi alla chiamata del nostro consulente</li>
            <li>• Controlla il pacco prima di pagare il corriere</li>
            <li>• Conserva lo scontrino - è la tua garanzia</li>
          </ul>
        </div>

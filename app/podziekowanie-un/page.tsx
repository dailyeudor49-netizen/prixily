...
function ThankYouContent() {
  ...
  const productName = landingConfig?.productName || 'Klimatyzator Ścienny Pro 2w1';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900">Co się teraz stanie?</h3>
            ...
            <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Nasz konsultant zadzwoni do Ciebie w ciągu 24 godzin, aby potwierdzić zamówienie i ustalić szczegóły dostawy.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-orange-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">2. Wysyłka w 24-48 godzin</h4>
                <p className="text-sm text-gray-600">
            ...
            <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Zapłacisz kurierowi gotówką lub kartą przy odbiorze paczki. Bez ryzyka!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6 mb-6">
          ...
          <ul className="text-sm text-yellow-800 space-y-1">
            ...
            <li>• Zachowaj paragon - to Twoja gwarancja</li>
          </ul>
        </div>

...
function ThankYouContent() {
  ...
  const landingSlug = searchParams.get('landing') || 'wallheater-un-sk';
  const customValue = searchParams.get('value');
  const transactionId = searchParams.get('tid');
  const isDouble = searchParams.get('double') === '1';

  // Konfigurácia landing pre Google Ads
  const landingConfig = getLandingConfig(landingSlug);

  // Dynamická hodnota konverzie
  const conversionValue = customValue ? parseFloat(customValue) : (landingConfig?.defaultValue || 84);
  const currency = landingConfig?.currency || 'EUR';
  const productName = landingConfig?.productName || 'Nástenná klimatizácia Pro 2v1';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900">Čo sa stane ďalej?</h3>
            ...
            <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Náš konzultant vám zavolá do 24 hodín, aby potvrdil objednávku a dohodol detaily doručenia.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-orange-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">2. Odoslanie za 24-48 hodín</h4>
                <p className="text-sm text-gray-600">
                  Po potvrdení objednávky bude balík odoslaný kuriérom. Dostanete číslo na sledovanie zásielky.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">3. Platba na dobierku</h4>
                <p className="text-sm text-gray-600">
                  Zaplatíte kuriérovi hotovosťou alebo kartou pri prevzatí balíka. Bez rizika!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6 mb-6">
          ...
          <ul className="text-sm text-yellow-800 space-y-1">
            ...
            <li>• Skontrolujte balík pred zaplatením kuriérovi</li>
